...
using static WAChatFlow.Shared.Models.WhatsApp.Requests.WhatsAppMessageRequest;
...
{
    public class UseTemplateBase : ComponentBase
    {
        ...
        protected string AgentPhoneParam { get; set; } = "525612711395";
                    ...
                    for (int i = 0; i < btnComp.Buttons.Count; i++)
                    {
                        ...
                        if (btnType == "URL")
                        {
                            ...
                            if (isCopyCode)
                            {
                                ...
                                rawValue = System.Text.RegularExpressions.Regex.Replace(rawValue.Trim(), "[^A-Za-z0-9]", "");
