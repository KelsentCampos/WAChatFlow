...
namespace WAChatFlow.Shared.Models.WhatsApp.Requests.Builders
{
    public sealed class WhatsAppRequestBuilder : IWhatsAppRequestBuilder
    {
        ...
        {
            var strongComponents = ConvertAnonymousToTemplateComponents(dto.Components);
            ...
            return new WhatsAppMessageRequest.Message
            {
                ...
                Template = new WhatsAppMessageRequest.Template
                {
                    ...
                    Components = strongComponents ?? new List<WhatsAppMessageRequest.TemplateComponent>()
                }
            };
        }
